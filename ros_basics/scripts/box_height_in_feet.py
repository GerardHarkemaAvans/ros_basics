...
import rospy
from ros_basics_msgs.msg import BoxHeightInformation
from ros_basics_msgs.srv import ConvertMetresToFeet, ConvertMetresToFeetRequest, ConvertMetresToFeetResponse
